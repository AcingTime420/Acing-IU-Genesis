...
| [ADR-002](ADR-002-canonical-repository-and-recovery.md) | Canonical repository and recovery sources | Accepted | 2026-08-16 |
| [ADR-003](ADR-003-modular-architecture.md) | Modular control-plane architecture and canonical backend paths | Accepted | 2026-08-16 |
| [ADR-004](ADR-004-zero-trust-security-baseline.md) | Zero-trust security baseline | Accepted | 2026-08-16 |
| [ADR-005](ADR-005-data-and-audit-boundaries.md) | Data ownership, migrations, and immutable audit logging | Accepted | 2026-08-16 |
